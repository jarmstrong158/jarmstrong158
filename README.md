...
AI/ML engineer. Multi-agent infrastructure, reinforcement learning agents, and MCP servers built from scratch, from transformer-based PPO agents to serverless agent coordination.
